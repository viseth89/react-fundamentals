      ...
      <Row>
        <Col xs="12">
          ...
          <dl>
            ...
            <dd>
              {" "}
              With tthe 'useSttate' hook, functional components can now botth
            ...
            <dd>
              With tthe 'useEffect' hook, functional components can perform side
              effects with any props or state changes.
            </dd>

            <dt>return()</dt>
            <dd>
              Must return a single element, but thtis element may have nested
              elements inside.
            </dd>
          </dl>
        </Col>
